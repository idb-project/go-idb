...
func (o *PostAPIV3MachinesRfqdnNicsParams) WithNic(nic *models.Nic) *PostAPIV3MachinesRfqdnNicsParams {
	o.SetNic(nic)
	return o
}

// SetNic adds the nic to the post Api v3 machines rfqdn nics params
func (o *PostAPIV3MachinesRfqdnNicsParams) SetNic(nic *models.Nic) {
	o.Nic = nic
}
