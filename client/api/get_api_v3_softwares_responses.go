...
func (o *GetAPIV3SoftwaresOK) Error() string {
	return fmt.Sprintf("[GET /api/v3/softwares][%d] getApiV3SoftwaresOK  %+v", 200, o.Payload)
}

func (o *GetAPIV3SoftwaresOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
