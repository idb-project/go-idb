...
func (o *PutAPIV3MachinesRfqdnNicsRnicReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutAPIV3MachinesRfqdnNicsRnicOK()
...
func NewPutAPIV3MachinesRfqdnNicsRnicOK() *PutAPIV3MachinesRfqdnNicsRnicOK {
	return &PutAPIV3MachinesRfqdnNicsRnicOK{}
}
...
func (o *PutAPIV3MachinesRfqdnNicsRnicOK) Error() string {
	return fmt.Sprintf("[PUT /api/v3/machines/{rfqdn}/nics/{rnic}][%d] putApiV3MachinesRfqdnNicsRnicOK  %+v", 200, o.Payload)
}

func (o *PutAPIV3MachinesRfqdnNicsRnicOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
